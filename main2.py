...
entrada = input("Ingresa su texto para cifrarlo: ")
...
def cifrado(serie, palabras):
    ...
    indexFibonacci = 0
    #print("Texto de serie: ", serie, "Texto de palabras: ", palabras)
...
print(f"Primer cifrado: {cifrado(serie, palabras)}")

texto_original = cifrado(serie, palabras)
texto_original2 = b'' + texto_original.encode('utf-8')

texto_cifrado2 = cipher_suite.encrypt(texto_original2)
print("Segundo cifrado:", texto_cifrado2)

#####################

# Descifra el mensaje
texto_descifrado2 = cipher_suite.decrypt(texto_cifrado2)

print("Segundo descifrado:", texto_descifrado2.decode())

import inverso

entrada2 = texto_descifrado2
